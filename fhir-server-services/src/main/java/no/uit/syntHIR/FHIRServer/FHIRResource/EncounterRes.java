...
public class EncounterRes {
	...
	private ArrayList<ExtensionRes> extension;
	...
	public ArrayList<ExtensionRes> getExtension() {
		return extension;
	}
	public void setExtension(ArrayList<ExtensionRes> extension) {
	...
	public String toString() {
		return "EncounterRes [resourceType=" + resourceType + ", id=" + id + ", meta=" + meta + ", extension="
				+ extension + ", identifier=" + identifier + ", status=" + status + ", myclass=" + myclass + ", type="
				+ type + ", subject=" + subject + ", location=" + location + ", hospitalization=" + hospitalization
				+ ", period=" + period + ", participant=" + participant + "]";
	}
